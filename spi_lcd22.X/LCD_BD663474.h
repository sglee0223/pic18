...
#define LCD_RST_H()		{LATDbits.LD0=1;}
#define LCD_RST_L()		{LATDbits.LD0=0;}

#define LCD_RS_H()		{LATAbits.LA2=1;}
#define LCD_RS_L()		{LATAbits.LA2=0;}

#define LCD_CS_H()		{LATAbits.LA1=1;}
#define LCD_CS_L()		{LATAbits.LA1=0;}
...
//void LCD_SetBacklight(unsigned char intensity);
...
void PutChinese(unsigned short Xpos,unsigned short Ypos,unsigned char *str,unsigned short Color,unsigned short bkColor); 
void GUI_Text(unsigned short Xpos, unsigned short Ypos, unsigned char *str,unsigned short Color, unsigned short bkColor);
void GUI_Chinese(unsigned short Xpos, unsigned short Ypos, unsigned char *str,unsigned short Color, unsigned short bkColor);	
void LCD_DrawPicture(unsigned short StartX,unsigned short StartY,unsigned short EndX,unsigned short EndY,unsigned short *pic);
